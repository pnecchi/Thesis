...
\begin{figure}[t]
	...
	\begin{tikzpicture}[node distance = 6em, auto, thick]
		...
		\onslide<3->{%
		\draw [->, line width=5pt, SteelBlue] (Environment) to [bend right=35] (Agent);
		\node at (0, 2.5) {\Large State $S_t$};
		}
		
		\onslide<4->{%
		\draw [->, line width=5pt, LightSteelBlue] (Agent) to [bend right=35] (Environment);
		\node at (0, -2.5) {\Large Action $A_t$};
		}
		
		\onslide<5->{%
		\draw [->, line width=5pt, LightSkyBlue] (Environment) to (Agent);
...
\begin{figure}[t]
	...
	\begin{tikzpicture}[node distance = 6em, auto, thick]
		...
		\onslide<2->{%
			\node [draw=LightSkyBlue, circle, line width=5pt, minimum size=2cm] at (-0, 0) (Value) {\Large $V_*$, $Q_*$};
			\node at (0, 1.5) {\Large Value Functions};
			\draw [->, line width=5pt, LightGray] (Model) to (Value);
		}

		\onslide<3->{%
			\node [draw=SteelBlue, circle, line width=5pt, minimum size=2cm] at (4, 0) (Policy) {\Large $\pi_*$};
		...
		\onslide<5->{%
			\node [draw=LightSkyBlue, circle, line width=5pt, minimum size=2cm] at (0, -3) (ApproxValue) {\Large $\widehat{V}$, $\widehat{Q}$};
			\node at (0, -4.5) {\Large Value-Based};
			\draw [dashed, line width=5pt, LightGray] (ApproxValue) to (Value);
		}
		
		\onslide<6->{%
			\node [draw=SteelBlue, circle, line width=5pt, minimum size=2cm] at (4, -3) (ApproxPolicy) {\Large $\widehat{\pi}$};
