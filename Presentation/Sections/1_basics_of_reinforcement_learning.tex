...
\begin{figure}[t]
	...
	\begin{tikzpicture}[node distance = 6em, auto, thick]
		...
		\onslide<5>{%
		\node[draw=RealRed, circle, line width=3pt, minimum size=1cm] at (-4, -2) {};
		}
		...
		\onslide<7>{%
		\node[draw=RealRed, circle, line width=3pt, minimum size=1cm] at (3.56, -2) {};	
		}
		
		\onslide<8>{%
		\node[draw=RealRed, circle, line width=3pt, minimum size=1cm] at (4.42, -2) {};	
		}
