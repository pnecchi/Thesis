...
def analyzeTransactionCostsImpact():
    ...
    for v, f in zip(propCostValues, filesList):
        ...
        dfTransactionCostPGPE.loc[v, statsConsidered] = dfStat.loc[statsConsidered, 'RSPGPE'].values
        dfTransactionCostNPGPE.loc[v, statsConsidered] = dfStat.loc[statsConsidered, 'RSNPGPE'].values
    ...
    dfTransactionCostPGPE.to_csv(outputDir + 'impact_transaction_costs_RSPGPE.csv')
    dfTransactionCostNPGPE.to_csv(outputDir + 'impact_transaction_costs_RSNPGPE.csv')
...
def analyzeShortSellingFeesImpact():
    ...
    dfTransactionCostPGPE.to_csv(outputDir + 'impact_short_selling_fees_RSPGPE.csv')
    dfTransactionCostNPGPE.to_csv(outputDir + 'impact_short_selling_fees_RSNPGPE.csv')
