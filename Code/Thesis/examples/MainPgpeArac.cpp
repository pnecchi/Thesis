...
int main()
{
    ...
    std::cout << "-            Parameter-based ARAC            -" << std::endl;
    std::cout << "----------------------------------------------" << std::endl;
    std::cout << std::endl;

    // 0) Parameters
    std::cout << "0) Read parameters" << std::endl;
    std::string parametersFilepath  = "../../../Data/Parameters/ParametersPgpeArac.pot";
    ...
    DecayingLearningRate criticLearningRate(0.1, 0.75);
    DecayingLearningRate actorLearningRate(0.1, 0.9);
    std::cout << "done" << std::endl;
